...
-   Click "Commit"
-   In the box that opens, type a message in "Commit message", such as "Initialize lab 2".
-   Click "Commit".
...
#| label: setup
#| setup: load-data
surveys <- read_csv(here:here("STAT 331", "Week 2", "Lab 2", "lab-2-icay711", "data", "surveys.csv"))
```
